...
import requests # Library for HTTP (HyperText Transfer Protocol) requests. Secured HTTP


# Insert your API token here
API_TOKEN = "c3f9a36dc9331b5ec10665efd6782d1ab7476b78"

# Edit this variable to see your city data 
city = "Mumbai"

# Endpoint for AQICN API
endpoint = f"https://api.waqi.info/feed/{city}/?token={API_TOKEN}" # formatted string literal (for variables within string)
...
def get_air_quality():
    ...
    if status != 'ok' or not data:
        ...
        return
    aqi = data.get("aqi", -1) # Gives aqi or put "-1"
